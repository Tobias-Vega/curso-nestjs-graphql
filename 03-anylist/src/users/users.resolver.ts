...
export class UsersResolver {
  ...
  @ResolveField(() => Int, { name: 'itemCount', nullable: true })
  async itemCount(
  ...
  @ResolveField(() => [Item], { name: 'items', nullable: true })
  ...
  @ResolveField(() => Int, { name: 'listCount', nullable: true })
  async listCount(
    @CurrentUser([ValidRoles.admin]) adminUser: User,
    @Parent() user: User,
  ): Promise<number> {
  ...
  @ResolveField(() => [List], { name: 'lists', nullable: true })
  async getListByUser(
    @CurrentUser([ValidRoles.admin]) adminUser: User,
    @Parent() user: User,
    @Args() paginationsArgs: PaginationArgs,
